            ...
            <table class="table table-bordered" style="margin-left: -10%;margin-top: 10px;">
                ...
                <tbody>
                    ...
                    if (isset($_POST['buscar'])) {
                        ...
                        $query = "SELECT * FROM proveedores WHERE correp_electronico='$dato'";
                        $resultado1 = mysqli_query($con, $query);

                        $queryval = "SELECT * FROM proveedores WHERE nombres='$dato'";
                        $resultado = mysqli_query($con, $queryval);
                    ...
                    <?php }
                            ...
                            if (headers_sent()) {
                                ...
                                echo "dato no encontrado solo nombres o correos";
